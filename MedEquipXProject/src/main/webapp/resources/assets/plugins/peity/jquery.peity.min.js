...
!(function (t, i, e, n) {
          ...
          this.each(function () {
            ...
            h
              ...
              : ((h = new r(
                  n,
                  i,
                  t.extend({}, a.defaults[i], n.data("peity"), e)
                )),
                n
                  .change(function () {
                    h.draw();
  ...
  (h.draw = function () {
    ...
    (h.prepare = function (t, i) {
      return (
        this.$svg ||
          this.$el.hide().after((this.$svg = s("svg", { class: "peity" }))),
    ...
    a.register(
      "pie",
      { fill: ["#ff9900", "#fff4dd", "#ffc66e"], radius: 8 },
      function (i) {
        if (!i.delimiter) {
    ...
    a.register(
      ...
      function (t) {
        ...
        g.push(p, d),
          t.fill &&
            h.append(s("polygon", { fill: t.fill, points: g.join(" ") })),
          l &&
            h.append(
              s("polyline", {
                fill: "none",
